...
import tech.beryllium.hangman_bluebarry.models.GameModel;
...
public class DataService {
    ...
    public GameDataModel getGameDataModel() throws IOException {
        ...
        //json
        GameDataModel output = ToGameDataModel(rawJson);
    ...
    private String getJsonByURL() throws IOException {
        HttpURLConnection getHttpURLConnection = (HttpURLConnection) this.getUrl.openConnection();
        getHttpURLConnection.setRequestMethod("GET");

        StringBuilder stringBuilder = new StringBuilder();

        BufferedReader buffReader = new BufferedReader(new InputStreamReader(getHttpURLConnection.getInputStream()));
    ...
    private String postJson(String json) throws IOException {
        HttpURLConnection connection = (HttpURLConnection) this.postUrl.openConnection();
